...
import { CreateUpdateSeriesRequest } from '../Model/CreateUpdateSeriesRequest.model';
import { PostInListDto } from '../../Content/Model/PostInListDto.model';
import { SeriesInListDtoPagedResult } from '../Model/SeriesInListDtoPagedResult.model';
@Injectable({
  providedIn: 'root'
})
